...
def purchase_game(request,game_id):
    ...
    if game.category.lower() == 'free':  # Ensure 'free' is correctly checked
    ...
    #         }],
    #         mode='payment',
    #         success_url=f'http://localhost:8000/users/payment_success/{game.id}/',
    #         cancel_url='http://localhost:8000/users/payment_cancel/',
    #     )
